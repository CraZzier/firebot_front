...
export class MainsiteComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   function handleClick(param) {
      ...
      console.log(`An user clicks at (${param.point.x}, ${param.point.y}) ${param.seriesPrices} point, the time is ${param.time}`);
  }
  ...
  const priceLine1 = candleSeries.createPriceLine({
    price: 80.0,
    color: 'green',
    lineWidth: 2,
    lineStyle: 0,
